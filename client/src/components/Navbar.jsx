...
const Navbar = () => {
  ...
  return (
    ...
    <div className = 'fixed top-0 left-0 z-50 w-full flex items-center justify-between px-6 md:mx lg:px-16 lg:px-36 py-5'>
     ...
     <SearchIcon  className='max-md:hidden w-6 h-6 cursor-pointer'/>
   {
     ...
     Login</button>) : ( <UserButton /> )
   }
    </div>
   <MenuIcon  className='max-md:md-4 md:hidden w-8 h-8 cursor-pointer'onClick={()=> setIsOpen(!isOpen)}/>
