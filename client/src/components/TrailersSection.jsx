    ...
    <div className='px-6 md:px-12 lg:px-24 xl:px-44 py-20 overflow-hidden'>
      ...
      <div className='grid grid-cols-4 gap-4 md:gap-8 mt-8 max-w-3xl mx-auto group'>
        {dummyTrailers.map((trailer, index) => (
          <div
            key={trailer.image}
            className={`relative transition duration-300 transform hover:-translate-y-1 cursor-pointer ${
              currentTrailer.videoUrl !== trailer.videoUrl ? 'opacity-60 group-hover:opacity-50' : ''
            }`}
